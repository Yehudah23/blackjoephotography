      ...
      <div class="flex justify-between items-center py-4">
        ...
        <nav class="nav-desktop">
          ...
          <div class="header-social-icons">
            <a href="https://www.instagram.com/blackjoefilms_?igsi=YTFxbmlrYmZtNXh2" target="_blank" rel="noopener noreferrer" class="header-social-icon" title="Instagram">
            ...
            <a href="https://x.com/themaskguyy?s=11&t=c8EMCc3yV0fmzbKmLXyBLQ" target="_blank" rel="noopener noreferrer" class="header-social-icon" title="X">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <nav class="flex flex-col gap-4">
          ...
          <div class="mobile-social-icons">
            ...
            <div class="flex gap-3 mt-2">
              <a href="https://www.instagram.com/blackjoefilms_?igsi=YTFxbmlrYmZtNXh2" target="_blank" rel="noopener noreferrer" class="mobile-social-icon" title="Instagram">
              ...
              <a href="https://x.com/themaskguyy?s=11&t=c8EMCc3yV0fmzbKmLXyBLQ" target="_blank" rel="noopener noreferrer" class="mobile-social-icon" title="X">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                </svg>
              </a>
